package com.internship.pokemon.security;
...
@Configuration
public class PokemonSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(configurer ->
                configurer
                        ...
                        .requestMatchers(HttpMethod.GET,"/gym").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET,"/gym/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST,"/gym").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/gym/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/gym/**").hasRole("ADMIN"));
